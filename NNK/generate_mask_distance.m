...
D_d_i = mask_positions(:,1).^2 + mask_positions(:,2).^2;%Dist. del pix central [0,0] hasta c/ pix
D_d_neighbors = mask_inter_positions(:,:,1).^2 + mask_inter_positions(:,:,2).^2;%Dist entre c/ pix
[~, index] = sort(D_d_i);
